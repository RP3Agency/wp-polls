...
if(!empty($_POST['do'])) {
	...
	switch($_POST['do']) {
		...
		case __('Add Poll', 'wp-polls'):
			...
			// Insert Poll
			$add_poll_question = $wpdb->query("INSERT INTO $wpdb->pollsq VALUES (0, '$pollq_question', '$pollq_followup', '$pollq_timestamp', 0, $pollq_active, '$pollq_expiry', $pollq_multiple, 0)");
...
<div class="wrap">
	...
	<table class="form-table">
		<tr>
			...
			<td width="80%"><textarea cols="70" rows="2" name="pollq_followup"></textarea><br />(256 Characters Max)</td>
		</tr>
	</table>
